...
http_jar(
    ...
    url = "https://artifactory.tcsbank.ru/ui/native/maven-central-used-proxy/junit/junit/4.12/junit-4.12.jar",
)

http_jar(
    name = "jimfs",
    # sha256 = "c4828e28d7c0a930af9387510b3bada7daa5c04d7c25a75c7b8b081f1c257ddd",
    url = "https://artifactory.tcsbank.ru/ui/native/maven-central-used-proxy/jimfs/jimfs/1.1/jimfs-1.1.jar",
)

http_jar(
    name = "guava",
    # sha256 = "4a5aa70cc968a4d137e599ad37553e5cfeed2265e8c193476d7119036c536fe7",
    url = "https://artifactory.tcsbank.ru/ui/native/maven-central-used-proxy/guava/guava/27.1-jre/guava-27.1-jre.jar",
)
